package com.pskwiercz.evaluators.controller;

import com.pskwiercz.evaluators.exception.InvalidAnswerException;
...
@RestController
@RequestMapping("/api")
public class SelfEvaluationChatController {
    ...
    public SelfEvaluationChatController(ChatClient.Builder chatClientBuilder) {
